...
* **/customers/** API path calls IBM Master Data Management services in MPLbank (Part II).
* **/accounts/** API path calls the Account Management System services in MPLbank (Part II).
